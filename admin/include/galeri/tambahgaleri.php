...
<section id="content-page" class="content-page">
  <div class="card card-info">
    ...
    <form class="form-horizontal" action="konfirmasi-tambah-galeri" method="POST" enctype="multipart/form-data">
      <div class="card-body">
        ...
        <div class="form-group row">
          ...
          <div class="col-sm-7">
            <input type="text" class="form-control" name="nama_galeri" id="nama" value="">
          </div>
        </div>
        <div class="form-group row">
          <label for="email" class="col-sm-3 col-form-label">Sinopsis</label>
          <div class="col-sm-7">
            <textarea class="form-control" name="sinopsis_galeri" id="editor1" rows="12"></textarea>
          </div>
        </div>
        <div class="form-group row">
          <label for="email" class="col-sm-3 col-form-label">Tanggal</label>
          <div class="col-sm-7">
            <input type="text" id="tanggal" class="form-control" name="tanggal" value="" readonly>
          </div>
        </div>
        <div class="col-sm-12">
